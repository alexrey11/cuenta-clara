...
const TIPO_INFO: Record<TipoLogSeguridad, { icon: string; label: string; tile: string; pill: string }> = {
    ...
    pdv_creado: { icon: '🏪', label: 'PDV creado', tile: 'from-indigo-500 to-violet-600', pill: 'bg-indigo-500/15 text-indigo-300 ring-1 ring-indigo-400/25' },
    pdv_editado: { icon: '✏️', label: 'PDV editado', tile: 'from-cyan-500 to-blue-600', pill: 'bg-cyan-500/15 text-cyan-300 ring-1 ring-cyan-400/25' },
    pdv_eliminado: { icon: '🗑️', label: 'PDV eliminado', tile: 'from-rose-500 to-red-600', pill: 'bg-rose-500/15 text-rose-300 ring-1 ring-rose-400/25' },
    pdv_cambio: { icon: '🔄', label: 'Cambio PDV', tile: 'from-amber-500 to-orange-600', pill: 'bg-amber-500/15 text-amber-300 ring-1 ring-amber-400/25' },
};
